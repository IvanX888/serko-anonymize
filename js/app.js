...
(function () {
  ...
  var TYPE_EXPAND = { bank_account: ['bank_account', 'bik'], ogrn: ['ogrn', 'kpp'], doc: ['doc', 'passport_ru'], ip: ['ip', 'url', 'net'], fio: ['fio', 'fio_lat'] };
  ...
  var TEST_TEXT = 'ДОГОВОР КУПЛИ-ПРОДАЖИ КВАРТИРЫ № 15/2025\n' +
    ...
    'Гражданин Республики Беларусь Андреенко Павел Викторович, паспорт серия KH № 4283716, выдан Гродненским ГОВД 20.05.2015, ' +
    'личный номер 3240812C003PB7, зарегистрирован по адресу: г. Гродно, ул. Ожешко, д. 45, кв. 78, именуемый в дальнейшем «Продавец», с одной стороны, и\n' +
    ...
    '2.2. Контактный телефон Продавца: +375 (29) 765-43-21, email: p.andreenko@example.by.\n' +
    ...
    'Продавец: Андреенко П.В. ____________\n' +
